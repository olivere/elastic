...
// https://www.elastic.co/guide/en/elasticsearch/reference/7.x/search-request-post-filter.html
// for details.
...
// See https://www.elastic.co/guide/en/elasticsearch/reference/7.x/search-request-version.html.
