...
// in Opensearch 5.0 to create a number of Goroutines, each
...
// for details on sliced scrolling in Opensearch.
//
// # Example
//
...
func main() {
	...
	for i := 0; i < *numSlices; i++ {
		...
		// Prepare the slice
		sliceQuery := opensearch.NewSliceQuery().Id(i).Max(*numSlices)
		if *field != "" {
