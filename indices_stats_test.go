...
func TestIndexStats(t *testing.T) {
	...
	stats, err := client.IndexStats(testIndexName).Pretty(true).Human(true).Do(context.TODO())
	if err != nil {
...
func TestIndexStatsWithShards(t *testing.T) {
	...
	stats, err := client.IndexStats(testIndexName).Level("shards").Pretty(true).Human(true).Do(context.TODO())
	if err != nil {
		t.Fatalf("expected no error; got: %v", err)
	}
	if stats == nil {
