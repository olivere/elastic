...
type NodesStats struct {
	...
	Network          *NodesStatsNetwork             `json:"network"`
...
type NodesStatsIndices struct {
	...
	FilterCache *NodesStatsIndicesFilterCache `json:"filter_cache"`
	IdCache     *NodesStatsIndicesIdCache     `json:"id_cache"`
...
type NodesStatsNetwork struct {
	TCP *NodesStatsNetworkTCP `json:"tcp"`
}
...
type NodesStatsIndicesFilterCache struct {
	MemorySizeInBytes int64 `json:"memory_size_in_bytes"`
	Evictions         int64 `json:"evictions"`
}

type NodesStatsIndicesIdCache struct {
	MemorySizeInBytes int64 `json:"memory_size_in_bytes"`
}
...
type NodesStatsProcessCPU struct {
	...
	SysInMs   int64 `json:"sys_in_millis"`
	UserInMs  int64 `json:"user_in_millis"`
...
type NodesStatsNetworkTCP struct {
