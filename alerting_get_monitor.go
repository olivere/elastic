...
// AlertingGetMonitorService get a monitor by its ID.
...
// Id is id of the monitor to get.
func (s *AlertingGetMonitorService) Id(id string) *AlertingGetMonitorService {
	s.id = id
	return s
}
